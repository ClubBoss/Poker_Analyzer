...
class QuickDailyPlayPage extends StatefulWidget {
  ...
  const QuickDailyPlayPage({super.key, this.planPath = 'out/plan/play_plan_v1.json', this.bundleDir = 'dist/training_v1'});
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (next == null)
                  const Expanded(child: Center(child: Text('All slices completed')))
                else
                  ElevatedButton(
                    onPressed: _loading
                        ? null
