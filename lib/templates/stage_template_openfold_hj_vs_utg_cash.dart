...
const LearningPathStageModel openFoldHjVsUtgCashStageTemplate = LearningPathStageModel(
  id: 'openfold_hj_vs_utg_cash',
  title: 'HJ vs UTG Open/Fold (Cash)',
  description: 'Decide whether to 3-bet or fold the Hijack facing an UTG 3bb open in 6-max cash games',
