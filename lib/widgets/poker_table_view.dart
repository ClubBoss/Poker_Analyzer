  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      final items = <Widget>[
        Positioned.fill(
            child:
                CustomPaint(painter: PokerTablePainter(theme: widget.theme))),
        Positioned.fill(
          child: Center(
            child: Stack(
      ...
      for (int i = 0; i < widget.playerCount; i++) {
        ...
        final seat = TableGeometryHelper.positionForPlayer(
            seatIndex, widget.playerCount, width, height);
        final offset = Offset(width / 2 + seat.dx - 20 * widget.scale,
        ...
        items.add(Positioned(
          ...
          child: GestureDetector(
            ...
            onLongPress: () async {
              final controller =
                  TextEditingController(text: widget.playerNames[i]);
        ...
        if (positions[seatIndex] == 'SB' || positions[seatIndex] == 'BB') {
          ...
          items.add(Positioned(
            ...
            child: BlindChipIndicator(
                label: positions[seatIndex], color: color, scale: widget.scale),
          ));
        }
            ...
            child: AnimatedSwitcher(
              ...
              child: Row(
                ...
                children: cardsToShow
                    .map((c) => PlayingCardWidget(card: c, scale: widget.scale))
                    .toList(),
              ),
            ),
          ));
          ...
          child: GestureDetector(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontWeight:
                    i == widget.heroIndex ? FontWeight.bold : FontWeight.normal,
